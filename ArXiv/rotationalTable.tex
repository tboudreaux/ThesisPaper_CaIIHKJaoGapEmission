\begin{deluxetable*}{ccccccccc}
  \tablehead{\colhead{ID} & \colhead{G Mag} & \colhead{V Mag} & \colhead{K Mag} & \colhead{$\log(R'_{HK})$} & \colhead{e\_Log(R'$_{HK}$)} & \colhead{Ro} & \colhead{prot} & \colhead{r\_prot}\\ \colhead{ } & \colhead{$\mathrm{mag}$} & \colhead{$\mathrm{mag}$} & \colhead{$\mathrm{mag}$} & \colhead{ } & \colhead{ } & \colhead{ } & \colhead{$\mathrm{d}$} & \colhead{ }}
\startdata
...
\enddata
\input{rotationalTableCaption.tex}
